	...
	<div class="contents">
        ...
        <!-- <div class="bannerGroup pgTopSort">
            <a href="javascript:void(0);" class="bannerBtn">
                <img src="/sellPhone/common/img/secondHandBanner_1.png">
            </a>
        </div> -->
        ...
        <div class="bannerGroup withTable">
            ...
            <table class="purcStatus">
                ...
                <tr>
                    <td colspan="2">
                        <div class="topTitle">실시간 매입현황</div>
                    </td>
                    <td class="topMoreBox">
                        <a href="javascript:void(0);" class="tOnlyBtn">MORE</a>
                    </td>
                </tr>
                </thead>
